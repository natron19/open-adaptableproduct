...
ActiveRecord::Schema[8.1].define(version: 2026_05_08_204433) do
  ...
  create_table "assumption_matrices", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "gemini_raw"
    t.datetime "generated_at"
    t.string "status", default: "pending", null: false
    t.uuid "strategy_product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_assumption_matrices_on_status"
    t.index ["strategy_product_id"], name: "index_assumption_matrices_on_strategy_product_id"
  end

  create_table "assumptions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "assumption_matrix_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["assumption_matrix_id"], name: "index_assumptions_on_assumption_matrix_id"
    t.index ["position"], name: "index_assumptions_on_position"
  end
  ...
  create_table "strategy_products", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "name", null: false
    ...
    t.datetime "updated_at", null: false
    t.uuid "user_id", null: false
    t.index ["user_id"], name: "index_strategy_products_on_user_id"
  end
  ...
  add_foreign_key "assumption_matrices", "strategy_products"
  add_foreign_key "assumptions", "assumption_matrices"
  add_foreign_key "llm_requests", "ai_templates"
  add_foreign_key "llm_requests", "users"
  add_foreign_key "password_resets", "users"
  add_foreign_key "strategy_products", "users"
end
